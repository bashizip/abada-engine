...
> **Roadmap Context**: This release completes the first milestone in the [Roadmap to Beta](../development/roadmap-to-1.0.md), establishing the observability foundation required for production-ready deployments.
...
According to the [Roadmap to Beta](../development/roadmap-to-1.0.md), the next releases will focus on:
