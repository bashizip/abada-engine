...
> **Roadmap Context**: This release fulfills the second milestone in the [Roadmap to Beta](../development/roadmap-to-1.0.md), focusing on the end-user task lifecycle.
...
Updated guides:
- **[Roadmap to Beta](../development/roadmap-to-1.0.md)**: Updated progress and next steps.
...
According to the [Roadmap to Beta](../development/roadmap-to-1.0.md), the next major focus will be:
